...
Figures3D FigureParser::parseWireframeFigure(const ini::Section &figure) {
    ...
    if (type == "LineDrawing") {
        ...
        Figure3D newFigure =  PlatonicFigure::parseTorus(rotations, scale, center, color, R, r, n, m);
        return {newFigure};
...
//        Figure3D octahedron = PlatonicFigure::createBuckyBall(rotations, scale, center, color);
//        return FigureFractaliser::generateFractal(octahedron, nrIterations, fractalScale);
//    } else if (type == "MengerSponge") {
//        Figure3D octahedron = PlatonicFigure::createMengerSponge(rotations, scale, center, color);
//        return FigureFractaliser::generateFractal(octahedron, nrIterations, fractalScale);
    } else {
        return {};
    }
