#ifndef CG_GRAPICS_ENGINE_FIGUREPARSER_H
#define CG_GRAPICS_ENGINE_FIGUREPARSER_H
...
public:
    ...
    static Figures3D parseWireframeFigure(const ini::Section& figure);
...
#endif //CG_GRAPICS_ENGINE_FIGUREPARSER_H
