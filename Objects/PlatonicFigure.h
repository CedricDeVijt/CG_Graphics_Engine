...
public:
    ...
    static Figure3D createBuckyBall(const std::vector<double> &rotations, const double &scale, const Vector3D& center, img::Color color);

    static Figure3D createMengerSponge(const std::vector<double> &rotations, const double &scale, Vector3D center, img::Color color);
